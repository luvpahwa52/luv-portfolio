...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: 'Next.js 16, Tailwind v4, Framer Motion, Lenis — and a Siri-style voice intro.',
    size: 'sm',
    accent: 'from-violet-500/30 via-purple-500/20 to-pink-500/30',
    year: '2026',
    role: 'Designer · Engineer',
    stack: ['Next.js 16', 'Tailwind v4', 'Framer Motion', 'Lenis', 'MDX'],
    problem: 'Most dev portfolios feel like résumés in HTML.',
    solution: 'Built a cinematic, voice-led experience with motion as a first-class citizen.',
    impact: ['Custom CursorGlow', 'JARVIS-style voice intro (Liba)', 'MDX blog with dynamic UI'],
    architecture: [
      { step: 'Shell', desc: 'Next.js App Router + Tailwind v4 tokens.' },
      { step: 'Motion', desc: 'Framer Motion + Lenis smooth scroll.' },
      { step: 'Voice', desc: 'Web Speech API with phrase rotation.' },
      { step: 'Content', desc: 'MDX-driven blog and case studies.' },
    ],
  },
]; 
